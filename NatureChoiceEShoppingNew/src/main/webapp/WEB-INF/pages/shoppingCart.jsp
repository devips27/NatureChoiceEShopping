...
<div class="shopping-cart">
   ...
   <c:if test="${not empty cartForm and not empty cartForm.cartLines   }">
       <form:form method="POST" modelAttribute="cartForm"
           ...
           <input class="btnLogin" type="submit" value="Update Quantity"  />
           <a  class="navi-item" 
               href="${pageContext.request.contextPath}/shoppingCartCustomer" style="color:yellow">Enter
               Customer Info</a>
           <a class="navi-item"
               href="${pageContext.request.contextPath}/productList" style="color:yellow">Continue
               Buy</a>
       </form:form>
